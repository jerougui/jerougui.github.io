...
% Vel (vel@LaTeXTemplates.com) and Rougui (jamal.rougui@gmail.com)
%
% License:
...
~
	\smartdiagram[bubble diagram]{
        ...
        \textbf{~~~MVC~~~},
        \textbf{~~~Indexation~~~}\\\textbf{~~~Multimédia~~~},
        \textbf{~~~R\&D~~~}
    }
}

\aboutme{\\
Lead technique TIC, 9 ans d'expérience professionnelle dans le secteur SI chez divers clients (Thales, INSEE, NEXTER, Bouygues, ...) à l'écoute, bon communiquant et force de proposition.
\\7 ans d'expérience en R\&D me procurant une forte capacité de trouver des solutions les plus efficaces et une grande envie pour l'innovation et les nouvelles technologies (NTIC).
...
\programming{{C++ $\textbullet$ Matlab  $\textbullet$ Machine Learning / 3}, {NoSQL $\textbullet$ PlSQL $\textbullet$ \large Python / 3.5}, {Java $\textbullet$ JavaFx $\textbullet$ Hibernate / 5}}
