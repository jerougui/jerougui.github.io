...
\aboutme{\\
 ...
 {\large \textbf{7}} ans d'expérience en R\&D me procurant une forte capacité de trouver des solutions les plus efficaces et une grande envie pour l'innovation et les nouvelles technologies (NTIC).
...
\programming{{C++ $\textbullet$ Matlab  $\textbullet$ Machine Learning / 3}, {SQL $\textbullet$ PlSQL $\textbullet$ \large Python / 3.5}, {Java $\textbullet$ JavaFx $\textbullet$ Hibernate / 5}}
