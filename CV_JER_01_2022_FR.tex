...
\aboutme{\\
 {\large \textbf{13}} ans d'expérience professionnelle dans le métier d'ingénierie informatique chez divers clients (Sncf TN, Thales, INSEE, NEXTER, Bouygues, ...) à l'écoute, bon communiquant et force de proposition.
...
\begin{twenty} % Environment for a list with descriptions
	...
	{\begin{itemize}	
			...
			\item Conception et macro-chiffrage d'évolution d'un parc applicatif cloud DevOps
